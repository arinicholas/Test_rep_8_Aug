...
We report on the dataset we have selected for our Group Project. It contains data on althetes from different sports. There are two categorical variables, 'Gender' and 'Sport', and seven continuous variables which are: weight, height, body mass index (BMI) etc, etc. 
